...
export class InitMigration1728180826241 implements MigrationInterface {
    name = 'InitMigration1728180826241'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`maintenance\` (\`id\` int NOT NULL AUTO_INCREMENT, \`name\` varchar(40) NOT NULL, \`description\` varchar(255) NOT NULL, \`created_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updated_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`status\` varchar(30) NOT NULL DEFAULT 'requested', \`maintenance_type_id\` int NULL, \`process_id\` int NULL, \`department_id\` int NULL, UNIQUE INDEX \`IDX_a056195f29a2b0b959470fbef4\` (\`name\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
