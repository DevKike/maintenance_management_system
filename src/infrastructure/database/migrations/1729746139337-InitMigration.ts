...
export class InitMigration1729746139337 implements MigrationInterface {
    name = 'InitMigration1729746139337'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`department_maintenance_type_assignment\` (\`id\` int NOT NULL AUTO_INCREMENT, \`assigned_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updated_at\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`status\` enum ('Active', 'Inactive', 'Expired', 'PendingApproval', 'Rejected') NOT NULL, \`priority\` int NOT NULL, \`comments\` text NOT NULL, \`department_id\` int NULL, \`maintenance_type_id\` int NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
