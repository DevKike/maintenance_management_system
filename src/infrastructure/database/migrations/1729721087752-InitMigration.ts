...
export class InitMigration1729721087752 implements MigrationInterface {
    name = 'InitMigration1729721087752'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`maintenance\` ADD CONSTRAINT \`FK_4e78fb5383944b20b8198d79ea6\` FOREIGN KEY (\`assignment_department_type_maintenance_id\`) REFERENCES \`assignment_department_type_maintenance\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`assignment_department_type_maintenance\` ADD CONSTRAINT \`FK_7b1aa81eea424e016eeb59f1d84\` FOREIGN KEY (\`department_id\`) REFERENCES \`department\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`assignment_department_type_maintenance\` ADD CONSTRAINT \`FK_1297cf443b04aa7c6bde9e91fd5\` FOREIGN KEY (\`maintenance_type_id\`) REFERENCES \`maintenance_type\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`assignment_department_type_maintenance\` DROP FOREIGN KEY \`FK_1297cf443b04aa7c6bde9e91fd5\``);
        await queryRunner.query(`ALTER TABLE \`assignment_department_type_maintenance\` DROP FOREIGN KEY \`FK_7b1aa81eea424e016eeb59f1d84\``);
        ...
        await queryRunner.query(`DROP TABLE \`assignment_department_type_maintenance\``);
